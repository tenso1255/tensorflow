...
class HloRaggedDotInstruction : public HloInstruction {
 public:
  ...
  // It allows a single ragged dimension, and operates in two modes:
  // 1. [m,k], [g,k,n], [g] -> [m,n], where the ragged dimension is the
  //    non-contracting dimension (m) of the lhs.
  // 2. [m,k], [k,n], [g] -> [g,m,n], where the ragged dimension is the

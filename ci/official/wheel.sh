...
tfrun bazel build $TFCI_BAZEL_COMMON_ARGS --config=cuda_wheel --//tensorflow/tools/pip_package:wheel_compliance=true //tensorflow/tools/pip_package:wheel $TFCI_BUILD_PIP_PACKAGE_ARGS
